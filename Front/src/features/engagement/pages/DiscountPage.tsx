  ...
  return (
    <div className="flex flex-col gap-[2.5rem] mt-[1.5rem]">
      <div className="flex flex-col gap-[0.5rem]">
        <h3 className="font-semibold">Discounts & Voucher</h3>
        <span className="text-gray-400">Add discount code to apply a discount in your purchase</span>
      </div>

      <div className="flex justify-between items-center w-[20rem] h-[4rem] bg-gray-25 rounded-[0.5rem] px-[1rem]">
        <input type="text" placeholder="label" className="w-full outline-none"/>
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
