...
const UserInfoField = ({
  ...
  return (
    <div className={className}>
      <span className="text-gray-400 ml-3 text-[0.9rem]">{title}</span>
      <div className="flex items-center justify-between gap-3 px-[1.5rem] bg-gray-25 h-[4rem] rounded-[0.5rem]">
        <div className="flex items-center gap-3 min-w-0 flex-1">
          <img src={icon} alt="icon" className="shrink-0" />
